...
type GroupChatMassMsg struct {
	...
	// 已发送群主计数
	DeliveredNum int `gorm:"comment:已发送群主计数;type:integer" json:"delivered_num"`
	// 已送达群聊数
	SuccessNum int `gorm:"comment:已送达群聊数;type:integer" json:"success_num"`
	// 未发送群主计数
	UnDeliveredNum int `gorm:"comment:未发送群主计数;type:integer"  json:"undelivered_num"`
	// 	未送达群聊
